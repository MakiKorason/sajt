...
<Container  className='container-day mt-4'>
    ...
    <Col md={6} className=' text-center '>
     ...
     <p className='container-text'>Ако сте у потрази за књигом која ће вам побудити најснажније емоције: туге, емпатије, сажаљења и разочарања,  онда је роман „Смртни исход атлетских повреда“ прави избор за вас.
      Приповедање које тече у првом лицу, избегавајући еуфемизам, ствара интимнији однос главне јунакиње и читаоца који верно прати њен живот и којем се пружа могућност да буде у исто време Евин психолог, судија и на крају писац који ће завршити поменути роман. </p>
