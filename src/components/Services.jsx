...
<hr/>
  ...
  <br/>  <li>Након тога, потребно је да корисник попуни Захтев за међубиблиотечку позајмицу подацима о књизи која се позајмљује. Образац захтева може преузети онлајн
  &nbsp;<a
