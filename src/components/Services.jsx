...
<hr/>
  ...
  <br/>  <li>Након тога, потребно је да корисник попуни Захтев за међубиблиотечку позајмицу подацима о књиги која се позајмљује. Образац захтева може преузети онлајн
  &nbsp;<a
  href="/наш образац за међубиблиотечку позајмицу.doc"
  download
