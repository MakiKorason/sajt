            ...
            < Card  className='events-card' >
              <Card.Body>
                <Card.Title className="container-title">
                  Дани Атанасија<br/> Стојковића <br/><BsCalendar2Heart />
                </Card.Title>
              
                <Card.Img style={{width:'170px', borderRadius:'50%'}} src={Atanasije} />
...
Србији. 
              <br/>
              Како бисте више сазнали о његовому лику и делу погледајте филм који су реализовали запослени наше установе.</p>
           
  <Card><div className='container-iframe'>
...
<p className='container-text'><br/>Подробније о Стојковићу баве се пре свега запослени наше установе, који у жељи да очувају сећање на овог великог просветитеља, сваке године на дан његовог рођења организују предавања која се баве његовим стваралаштвом. </p>
   <div className="container-icon">
     <LiaBookSolid /><LiaBookSolid/><LiaBookSolid/></div> 
      ...
      <Col md={6}>
      <p className='container-text'>КВИЗ „ЖИВОТ И ДЕЛО АТАНАСИЈА СТОЈКОВИЋА“
