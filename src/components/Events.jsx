          ...
          <Col md={6} xs={12} sm={12} lg={6} xl={6} className='text-center'>
            <AnimatedCard className='events-card'>
              <Card.Body>
                ...
                <Button className='btn-secondary' onClick={handleShowEvent1}>Детаљније</Button>
              </Card.Body>
            </AnimatedCard>
          </Col>
          ...
          <Col md={6} xs={12} sm={12} lg={6} xl={6} className='text-center'>
            <AnimatedCard className='events-card'>
              <Card.Body>
                ...
                <Button className='btn-secondary' onClick={handleShowEvent2}>Детаљније</Button>
              </Card.Body>
            </AnimatedCard>
          </Col>
        </Row>
          ...
          <Col md={6} xs={12} sm={12} lg={6} xl={6} className='text-center'>
            <AnimatedCard className='events-card'>
              <Card.Body>
                ...
                <br/><Button className='btn-secondary' onClick={handleShowEvent3}>Детаљније</Button>
              </Card.Body>
            </AnimatedCard>
          </Col>
          ...
          <Col md={6} xs={12} sm={12} lg={6} xl={6} className='text-center'>
            <AnimatedCard className='events-card'>
              <Card.Body>
                ...
                <br/><Button className='btn-secondary' onClick={handleShowEvent4}>Детаљније</Button>
              </Card.Body>
            </AnimatedCard>
          </Col>
        </Row>
        ...
        <Modal.Body>
            <Col md={12}>
              ...
              Румска књижевна колонија настала је из идеје и потребе да се савремено књижевно стваралаштво што боље представи и обогати.
               Наша библиотека успела је у намери да књижевном колонијом међuсобно повеже писце, афимирше, популаризује читање и 
               читалачке навике и интензивира сарадњу међu књижевним стараоцима. 
            <br/> </p></Col>
             <Row>
...
<hr/>Тема прошлогодишње 7. Румске књижевне колоније је "Књижевност измеђu принуде и слободе".
...
Драгољуба Јовановића. Одржан је и хуманитарni
koncert koji je okupio ljubitelje muzike uz posebnu
pažnju na humanitarni karakter događaja.
<br/>Svi ovi događaji potvrđuju značaj kulturnih
aktivnosti u Rumi i njenim institucijama,
pružajući platformu za kreativnost i razmenu ideja.
            </p>   
          </div>
        </Modal.Body>
        <Modal.Footer>
